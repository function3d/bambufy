...
- Используйте этот [3MF](https://github.com/function3d/bambufy/releases/download/v1.1.0/Bunny+v3+-+Multicolor_bambu.3mf) для Bambu Studio
- Используйте этот [3MF](https://github.com/function3d/bambufy/releases/download/v1.1.0/Bunny+v3+-+Multicolor_orca.3mf) для Orca Slicer.
- Используйте эти [G-коды для станка](https://github.com/function3d/bambufy/blob/master/MACHINE_GCODE.md) и инструкции, если вы собираетесь создать свой собственный профиль с нуля.
